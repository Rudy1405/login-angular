 ...
 * it uses HTML5 local storage for storing registered user data and provides fake implementations for authentication
 * and CRUD methods, these would be handled by a real api and database in a production application.
  ...
  In this case the FakeBackendInterceptor intercepts certain requests based on their URL and provides a fake response instead of
  going to the serv
 */
